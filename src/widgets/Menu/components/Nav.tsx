...
const Nav: React.FC<Props> = ({ account, login, logout, isMobile, isPushed, pushNav, Trans }) => {
  return isMobile ? (
    <MobileNav>
    ...
    <StyledNav>
      ...
      <Flex position="absolute" right={pxToRem(60)}>
        ...
        <UserBlock isMobile={isMobile} account={account} login={login} logout={logout} Trans={Trans} />
      </Flex>
