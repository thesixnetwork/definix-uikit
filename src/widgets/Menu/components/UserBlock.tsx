    ...
    isMobile ? (
      <Wrapper>
        <Flex pl="12px" flexDirection="column" alignItems="flex-start">
          <Text mt="55px" textStyle="R_12R" color="greyscale.mediumgrey">
            Wallet Address
          </Text>
          <Flex>
            <Text mt="2px" mr="4px" textStyle="R_18M" color="greyscale.black">
              {accountEllipsis}
            </Text>
        ...
        <StyledButton href="/farm">
          <Text textStyle="R_12M" color="greyscale.white">
            Net worth
          </Text>
          <Flex ml="12px" alignItems="center">
            <Text mr="7px" textStyle="R_12B" width="140px" color="greyscale.white">
              $132123123
            </Text>
